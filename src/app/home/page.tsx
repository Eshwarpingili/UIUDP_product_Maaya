      ...
      <Card title="Quick actions" subtitle="Jump to key tasks.">
        <div className="grid grid-cols-3 gap-3">
          <Link href="/body" className="flex flex-col items-center justify-center gap-2 pressable p-3 rounded-2xl bg-black/5 hover:bg-black/10 transition-colors">
            <div className="w-12 h-12 rounded-xl bg-white flex items-center justify-center shadow-sm p-3">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-highlight"><path d="M12 2v20"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
            </div>
          ...
          <Link href="/reports/upload" className="flex flex-col items-center justify-center gap-2 pressable p-3 rounded-2xl bg-black/5 hover:bg-black/10 transition-colors">
            <div className="w-12 h-12 rounded-xl bg-white flex items-center justify-center shadow-sm p-3">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#a78bfa]"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" x2="12" y1="3" y2="15"/></svg>
            </div>
